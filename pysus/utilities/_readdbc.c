...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 21), // int()(unsigned int(*)(void *, unsigned char * *), void *, int(*)(void *, unsigned char *, unsigned int), void *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 11), // unsigned int(*)(void *, unsigned char * *)
/*  2 */ _CFFI_OP(_CFFI_OP_POINTER, 23), // void *
/*  3 */ _CFFI_OP(_CFFI_OP_POINTER, 6), // int(*)(void *, unsigned char *, unsigned int)
/*  4 */ _CFFI_OP(_CFFI_OP_NOOP, 2),
/*  5 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  6 */ _CFFI_OP(_CFFI_OP_FUNCTION, 21), // int()(void *, unsigned char *, unsigned int)
/*  7 */ _CFFI_OP(_CFFI_OP_NOOP, 2),
/*  8 */ _CFFI_OP(_CFFI_OP_POINTER, 22), // unsigned char *
...
/* 15 */ _CFFI_OP(_CFFI_OP_FUNCTION, 23), // void()(char * *, char * *)
/* 16 */ _CFFI_OP(_CFFI_OP_POINTER, 19), // char * *
...
static void _cffi_d_dbc2dbf(char * * x0, char * * x1)
{
  dbc2dbf(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_dbc2dbf(PyObject *self, PyObject *args)
{
  char * * x0;
  char * * x1;
  Py_ssize_t datasize;
...
#else
#  define _cffi_f_dbc2dbf _cffi_d_dbc2dbf
#endif

static unsigned int _cffi_d_inf(void * x0, unsigned char * * x1)
{
  return inf(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_inf(PyObject *self, PyObject *args)
{
  void * x0;
  unsigned char * * x1;
  Py_ssize_t datasize;
...
#else
#  define _cffi_f_inf _cffi_d_inf
#endif

static int _cffi_d_outf(void * x0, unsigned char * x1, unsigned int x2)
{
  return outf(x0, x1, x2);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_outf(PyObject *self, PyObject *args)
{
  void * x0;
  unsigned char * x1;
  unsigned int x2;
...
#else
#  define _cffi_f_outf _cffi_d_outf
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "blast", (void *)_cffi_f_blast, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_blast },
  { "dbc2dbf", (void *)_cffi_f_dbc2dbf, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 15), (void *)_cffi_d_dbc2dbf },
  { "inf", (void *)_cffi_f_inf, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 11), (void *)_cffi_d_inf },
  { "outf", (void *)_cffi_f_outf, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 6), (void *)_cffi_d_outf },
};
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__readdbc(void) { return NULL; }
#  else
     init_readdbc(void) { }
#  endif
#  endif
